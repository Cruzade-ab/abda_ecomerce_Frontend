    ...
    <div>
      <nav className=" relative w-full border border-gray-300 bg-white top-0 right-0 left-0 ">
        <div className=" flex justify-between px-4 mx-auto lg:max-w-7xl md:items-center md:flex md:px-8 ">
          <div>
            <div className="flex flex-1 items-center py-3 md:py-5 md:flex">
              {/*Titulo de la Pagina (LOGO)*/}
              <Link href="/">
                <h1 className="text-xl flex flex-start" style={fontStyle}>
                  ABDA Shirts
                </h1>
              </Link>
              ...
              <div className="md:hidden">
                <button
                  className="p-2 flex flex-end  text-gray-600 rounded outline-none  focus:border-gray-400 "
          ...
          <div>
            <div
              className={`flex-1 h-auto justify-self-center pb-3 mt-8 md:block md:pb-0 md:mt-0 ${
                navbar ? "p-12 md:p-0 block" : "hidden"
              }`}
            >
              <ul className="h-screen pt-3 md:h-auto md:w-full items-center justify-center  md:flex">
